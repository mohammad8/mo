...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://pmresansaz-mohdsfs.rhcloud.com//'.$chat_id.'/pvresan.php');
...
🚀 @mohammad_poker"));
        ...
        }else if ($matches[0] != "/update"&&$matches[1] != ""&&$matches[2] != ""&&$chat_id == 167421305) {
